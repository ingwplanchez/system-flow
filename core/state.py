...
def init_session_state():
    ...
    if 'df_tareas' not in st.session_state:
        st.session_state['df_tareas'] = pd.DataFrame([
            ...
            {"timestamp": "2026-06-24 11:30", "task_id": "T-005", "project": "Nexus Flow", "module_task": "Diseño de PCB en KiCad", "category": "collaboration", "priority": "medium", "est_hours": 1.0, "real_hours": 1.5, "difficulty": 2, "status": "Completed"},
            {"timestamp": "2026-06-24 14:00", "task_id": "T-006", "project": "Vendedor Digital", "module_task": "Configuración de Webhooks n8n", "category": "strategy", "priority": "low", "est_hours": 2.0, "real_hours": 1.5, "difficulty": 3, "status": "Completed"},
            ...
            {"timestamp": "2026-06-26 16:00", "task_id": "T-008", "project": "Ultra Enfoque", "module_task": "Integración API Stripe", "category": "deep_work", "priority": "high", "est_hours": 2.0, "real_hours": 2.0, "difficulty": 5.0, "status": "Completed"}
        ])
